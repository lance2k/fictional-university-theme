      ...
      this.resultsDiv.html(`
                <div class="row">
                    ...
                    <div class="one-third">
                        ...
                        ${results.professors.length ? '<ul class="professor-cards">' : `<p>No professors match that search. <a href="${universityData.root_url}/professors">View all professors</a></p>`}
                            ${results.professors.map(item => `        <li class="professor-card__list-item">
                                        <a class="professor-card"
                                            ...
                                            <img class="professor-card__image"
                                                ...
                                                alt="${item.title}">
                                            <span
                                                class="professor-card__name">${item.title}</span>
                                        </a>
                                    </li>`).join("")}
