...
function pageBanner($args = ['title' => null, 'subtitle' => null, 'photo' => null])
{
    if (!$args['title']) {
...
function redirectSubsToFrontend()
{
    ...
    if (1 == count($ourCurrentUser->roles) and 'subscriber' == $ourCurrentUser->roles[0]) {
...
function makeNotePrivate($data, $postarr)
{
    ...
    if ('note' == $data['post_type'] and 'trash' != $data['post_status']) {
